 ...
 *
 *  	Developed by ほえたん(Hoetan) -- 2017/07/22
...
public class FBXExporterForUnity : MonoBehaviour
{
    ...
    [DllImport("FBXExporterForUnity")]
	public static extern bool FBXExporterSave(string pcName, string pcVersion, int iFileFormat, string pcFileFormat2, bool bEmbedMedia);
	[DllImport("FBXExporterForUnity")]
    ...
    [DllImport("FBXExporterForUnity")]
    public static extern bool FBXExporterSetNodeMeshMorph(float[] fVertexMorph, float[] fNormalMorph);
    [DllImport("FBXExporterForUnity")]
    ...
    {
        eDefault,
        eFBX_53_MB55_COMPATIBLE,
        eFBX_60_COMPATIBLE,
        eFBX_2005_08_COMPATIBLE,
        eFBX_2006_02_COMPATIBLE,
        eFBX_2006_08_COMPATIBLE,
        eFBX_2006_11_COMPATIBLE,
        eFBX_2009_00_COMPATIBLE,
        eFBX_2009_00_V7_COMPATIBLE,
        eFBX_2010_00_COMPATIBLE,
    ...
    void OnApplicationQuit() {
		if (bFirst) {
			...
			if (!bSave && bOutFBX) {
                ...
                string[] strVersions = { "", "FBX53_MB55", "FBX60_MB60", "FBX200508_MB70", "FBX200602_MB75", "FBX200608", "FBX200611", "FBX200900", "FBX200900v7", "FBX201000", "FBX201100", "FBX201200", "FBX201300", "FBX201400", "FBX201600" };
                ...
                FBXExporterSave(strFilename2, strVersions[(int)eFBXExportFileVersion], (int)eFBXFileFormat, (string)strFileFormat2, bEmbedMedia);
            ...
            if (meshSkin || meshF)
            {
                ...
                if (mesh)
                {
                    ...
                    for (i = 0; i < mesh.blendShapeCount; i++)
                    {
                        ...
                        mesh.GetBlendShapeFrameVertices(i, 0, vecVertexMorph, vecNormalMorph, vecTangentMorph);
                        float[] fVertexMorph = new float[mesh.vertices.Length * 3];
                        float[] fNormalMorph = new float[mesh.vertices.Length * 3];
                        k = 0;
                        for (int j = 0; j < mesh.vertices.Length; j = j + 3)
                        {
                        ...
                        //FBXExporterSetNodeMeshMorph(fVertexMorph, fNormalMorph);
                    }
                    */
                    ...
                    if (rendrMain)
                    {
                        ...
                        for (i = 0; i < matMains.Length; i++)
                        {
                            ...
                            if (material)
                            {
                                ...
                                string strDestPathTextureShiniess = "";
