...
FBX Importer for Unity β Version 2017/08/06
...
■対応3Dエンジン
 ...
 Unity Personal/Professional v5.6.3f1 (64bit)
...
■対応Visual C++ランタイム
 ...
 Visual Studio 2015 Update 3 の Visual C++ 再頒布可能パッケージ: https://www.microsoft.com/ja-jp/download/details.aspx?id=53587
...
■使用ライブラリ(DLL)
 ...
 FBX SDK 2018.1.1 VS2015 (64bit): http://www.autodesk.com/products/fbx/overview

※「DllNotFoundException: Assets/FBXImporter&ExporterForUnity/FBXImporterForUnity/Plugins/x86_64/FBXImporterForUnity.dll」のエラーがでた場合は、上記のＳＤＫにあるＤＬＬのコピーが必須です。

　「C:\Program Files\Autodesk\FBX\FBX SDK\2018.1.1\lib\vs2015\x64\release\libfbxsdk.dll」を、Unityプロジェクトのルート（※）へコピーしてください。
...
　FBXファイルは、3ds Max 2016 / Maya 2016 / Softimage 2015/ MotionBuilder 2016とFBX Exporter for Unityに対応しています。
...
Copy the DLL found from this path, "C:\Program Files\Autodesk\FBX\FBX SDK\2018.1.1\lib\vs2015\x64\release\libfbxsdk.dll", to the root (*) of the Unity project.
